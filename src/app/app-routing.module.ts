...
const routes: Route[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'applied-tuition-details/:id', component: AppliedTuitionDetailsComponent, canActivate: [TeacherGuard] },
      { path: 'activated-tuition', component: UnlockedTuitionListComponent, canActivate: [TeacherGuard] },
      { path: 'activated-tuition-details/:id', component: UnlockedTuitionDetailsComponent, canActivate: [TeacherGuard] },
